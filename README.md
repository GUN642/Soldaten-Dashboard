...
Der Build startet von selbst, sobald du eine Datei ins Repository hochlädst.

1. Im Repository oben auf den Reiter **Actions**
2. Oben steht der gerade gestartete Lauf
3. Warten (beim ersten Mal etwa 5–10 Minuten). Ein grüner Haken bedeutet: fertig.
4. Den abgeschlossenen Lauf anklicken → unten unter **Artifacts** liegt
   **Dienst-Cockpit-APK** → herunterladen

Von Hand geht es weiterhin: links **APK bauen** auswählen, rechts auf
**Run workflow**.
...
* `AgendaWidgetService.java` — füllt die scrollbare Liste
* `agenda_widget.xml`, `agenda_zeile.xml` — Aufbau der Anzeige
